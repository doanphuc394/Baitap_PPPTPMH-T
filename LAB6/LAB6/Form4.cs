...
namespace LAB6
{
    public class Form4 : Form
    {
        ...
        private Button btnThem, btnSua, btnXoa, btnClear, btnRefresh, btnDong;
        ...
        {
            this.Text = "Quản lý Nhà Xuất Bản (1150080031_Đoàn Phúc)";
            ...
            btnXoa = new Button { Text = "Xóa", Location = new Point(baseX + 90, baseY + 260), Width = 225 };
            btnClear = new Button { Text = "Xóa ô nhập", Location = new Point(baseX + 90, baseY + 300), Width = 225 };
            btnRefresh = new Button { Text = "Làm mới DS", Location = new Point(baseX + 90, baseY + 340), Width = 225 };
            btnDong = new Button { Text = "Đóng", Location = new Point(baseX + 90, baseY + 380), Width = 225 };
            ...
            this.Controls.AddRange(new Control[]
            {
                ...
                btnThem, btnSua, btnXoa, btnClear, btnRefresh, btnDong
            });
        ...
        private void BtnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có chắc muốn xóa NXB '" + ma + "' không?",
            ...
            {
                using (var con = new SqlConnection(_connStr))
                using (var cmd = new SqlCommand("dbo.XoaNhaXuatBan", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@MaXB", SqlDbType.Char, 10).Value = ma;
